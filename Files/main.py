...
from design_py.ui_addEditCoffeeForm import Ui_Dialog
from design_py.ui_main import Ui_MainWindow


class Edit_Dialog(QDialog, Ui_Dialog):
...
# pyuic5 addEditCoffeeForm.ui -o ui_addEditCoffeeForm.py
# pyinstaller -F --noconsole --add-data "data;data" main.py
